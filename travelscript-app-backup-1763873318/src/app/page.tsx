      ...
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">
            Powered by ZK Proofs + Flare FDC + EVVM
          </p>
        </div>
        ...
        {!isConnected ? (
          <div className="text-center">
            <button
              onClick={() => open()}
              className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl"
            >
              Connect Wallet
            </button>
            <p className="text-sm text-gray-500 mt-4">
              Login with Email, Google, GitHub or Wallet
            </p>
          </div>
        ) : (
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <ul className="text-sm text-gray-600 space-y-2">
            ...
            <li>✓ EVVM gasless transactions for better UX</li>
